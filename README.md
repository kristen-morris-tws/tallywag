...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/tallywag#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tallywag
```

A live public deployment of this template is available at [https://tallywag.templates.workers.dev](https://tallywag.templates.workers.dev)
